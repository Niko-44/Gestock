...
public class ControladorUsuario implements IControladorUsuario {
    ...
    public void crearNuevoUsuario(String nombre, String apellido, String email, String contrasenia)
    {
        if (this.servicioUsuarios.validateEmail(email))
        {
            System.out.print("El email existe");
        }
        else
        {
            servicioUsuarios.insertarUsuarios(nombre, apellido, email, contrasenia);
        }
    }
